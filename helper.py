...
def monthly_timeline_stats(selected_user,df):
...
def daily_timeline_stats(selected_user,df):
...
def week_activity_map_stats(selected_user,df):
...
def month_activity_map_stats(selected_user,df):
...
def create_wordcloud_stats(selected_user,df):
...
def most_common_words_stats(selected_user,df):
...
def emoji_helper_stats(selected_user,df):
    if selected_user != 'Overall':
        df = df[df['user'] == selected_user]
